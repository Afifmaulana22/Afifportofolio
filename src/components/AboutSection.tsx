...
const INFO = [
  { label: 'Nama',       value: 'Afif Maulana', icon: '✨' },
  { label: 'Umur',       value: '23 Tahun',    icon: '🎂' },
  { label: 'Gender',     value: 'Male',        icon: '👤' },
  { label: 'Pendidikan', value: 'Bachelor System Information',     icon: '🎓' },
  { label: 'Status',     value: 'Graduate',     icon: '📚' },
  { label: 'Location',   value: 'Indonesia',   icon: '🌏' },
];

const USE_VIDEO = false;
const MEDIA_SRC = USE_VIDEO ? '/video.mp4' : '/afif.png';
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center gap-4 text-center px-6">
                  ...
                  <div>
                    <p className="font-display font-bold text-white text-lg">Afif Maulana</p>
                  ...
                  <p className="text-xs font-mono" style={{ color: '#2a2a2a' }}>
                    {USE_VIDEO ? 'public/video.mp4' : 'public/afif.png'}
                  </p>
                </div>
              </div>
            </TiltCard>
          ...
          >
            <div className="flex flex-col gap-4">
              <p className="text-lg leading-relaxed" style={{ color: '#888' }}>
                ...
                , seorang Mahasiswa berusia 23 tahun yang passionate di dunia web development dan teknologi.
              </p>
